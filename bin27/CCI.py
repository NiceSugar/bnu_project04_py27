...
def main():
    ...
    #     dir = fdir+folder+'\\'
    #     print(dir, outdir+folder)
    #     # exit()
    #     compose_month(dir, out_dir=outdir+folder+'\\')
    #     exit()
    # exit()

    # for m in range(1,13):
    #     m='%02d'%m
    #     img = np.load('month_compose_'+m+'.npy')
    #     img = np.ma.masked_where(img<-999,img)
    #     plt.figure()
    #     plt.imshow(img)
    #     plt.title(m)
    #     plt.colorbar()
    # plt.show()
    # rasterized_tif = this_root+'conf\\china_cci_T_F.tif'
    # out_arr = this_root+'conf\\china_cci_mask'
    # gen_mask_array(rasterized_tif,out_arr)
    # rasterized_tif =
    # clip_array = np.load(this_root+'conf\\china_cci_mask.npy')[::-1]
    # plt.imshow(clip_array)
    #
    # save_array = this_root+'conf\\lon_lat_dic_cci.npy'
    # save_array = np.load(save_array).item()
    # save_array = dict(save_array)
    # for i in save_array:
    #     print(i)
    #     print(save_array[i])
    # plt.show()
    # gen_lon_lat_dic(rasterized_tif, clip_array, save_array)
    # lon_lat_dic = np.load(this_root+'conf\\lon_lat_dic_cci.npy').item()
    # lon_lat_dic = dict(lon_lat_dic)
    # cliped_dir = 'D:\\project04\\CCI\\composed\\'
    # save_path = 'D:\\project04\\CCI\\data_transform\\data_transform.npz'
    # save_path = this_root+'CCI\\data_transfom.npz'
    # # transform_data_npz(lon_lat_dic, cliped_dir, save_path)
    # data_trans = np.load(save_path)
    # for i in data_trans:
    #     print(i)
    #     # print(data_trans[i])
    #     print(len(data_trans[i]))
    #     vals = data_trans[i]
    #     vals = np.ma.masked_where(vals>1,vals)
    ...
    # for f in all_interp_dic:
    #     save_all_interp_dic(all_interp_dic[f],f)
...
if __name__ == '__main__':
    ...
    # gen_mask_array(output,'midasia')
    # arr = np.load(output)[::-1]
    # input_arr = 'D:\\project04\\CCI\\composed\\1983\\month_compose_09.npy'
    # clip_arr = np.load('midasia.npy')[::-1]
    #
    # out_arr = 'clipped.npy'
    # #
    ...
    #
    # out_arr = np.load('clipped.npy')
    # out_arr = np.ma.masked_where(out_arr<0,out_arr)
    # plt.imshow(out_arr,'jet')
    # plt.colorbar()
    # plt.show()
    # arr = np.load('D:\\project04\\CCI\\composed\\1986\\month_compose_06.npy')
